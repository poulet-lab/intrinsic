...
ui_params = { ...
    ...
    'd'    	'Stimulus Duration / s'	'edit'      4       [0  600];   ...
    'pre'  	'Pre-Stimulus / s'      'edit'      4       [0  600];   ...
    'post' 	'Post-Stimulus / s'     'edit'      8       [0  600];   ...
...
xlabel(hui.axes,'Time (s)')
ylabel(hui.axes,'Stimulus Amplitude (V)')
zoom xon
...
%% Callback Functions
    ...
    function ui_callback(hobj,~,~)
        ...
        hui.plot.YData = Y;
        xlim(hui.axes,[-stim.pre stim.post+stim.d]) % Set axes limits
