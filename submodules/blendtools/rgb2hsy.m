...
pict=im2double(inpict);
yc(:,:,1)=pict(:,:,1)*A(1,1)+pict(:,:,2)*A(1,2)+pict(:,:,3)*A(1,3);
yc(:,:,2)=pict(:,:,1)*A(2,1)+pict(:,:,2)*A(2,2)+pict(:,:,3)*A(2,3);
yc(:,:,3)=pict(:,:,1)*A(3,1)+pict(:,:,2)*A(3,2)+pict(:,:,3)*A(3,3);
